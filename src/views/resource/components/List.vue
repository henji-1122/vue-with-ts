...
<script lang="ts">
import Vue from 'vue'
import { getResourcePages } from '@/services/resource.ts'
...
export default Vue.extend({
  ...
  created () {
    this.loadResources() // 加载资源信息
    this.loadResourceCategories() // 加载资源信息
  },
  ...
  methods: {
    ...
    handleSizeChange (val: number) {
      ...
      this.form.size = val // 修改每页大小
      this.form.current = 1 // 每页大小改变，重新重新第一页数据
      this.loadResources()
    },
